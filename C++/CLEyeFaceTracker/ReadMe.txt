About CLEyeFaceTracker Sample
=============================

The CLEyeFaceTracker is a simple console application written in C++. 
It demonstrates the use of CLEyeMulticam API with OpenCV framework. 

Instructions:
=============

The CLEyeFaceTracker will automatically track faces detected in the camera view.
